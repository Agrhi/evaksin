  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="<?= base_url('dashboard') ?>">
        ...
        <span class="ms-1 font-weight-bold">E - Vaksin</span>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <?php if ($this->session->userdata('role') == 1) { ?>
          ...
          <!-- Data Penduduk -->
          <li class="nav-item">
            <a class="nav-link <?= ($title === "Data Penduduk") ? 'active' : '' ?> " href="<?= base_url('data_penduduk') ?>">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
          ...
          <!-- Target Vaksin -->
          <li class="nav-item">
            <a class="nav-link <?= ($title === "Target Vaksin") ? 'active' : '' ?> " href="<?= base_url('target') ?>">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              ...
              <span class="nav-link-text ms-1">Target Vaksin</span>
            </a>
          </li>
          <!-- Management User -->
          <li class="nav-item">
          ...
          <!-- Loker -->
          <!-- <li class="nav-item">
            <a class="nav-link <?= ($title === "Lowongan Pekerjaan") ? 'active' : '' ?> " href="<?= base_url('loker') ?>">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
